...
/** @typedef    void (*tLynxArrayListInit) (LynxArrayList
                                            *myArrayList,
                                            long increaseStep
                                           );
    @brief  定义了LynxArrayListInit的类型，方便函数指针转换
*/

/** @typedef    typedef void (*tLynxArrayListDestroy) (LynxArrayList
                                                       myArrayList,
                               BOOL (*freeElement) (void *elem)
                              );
    @brief  定义了LynxArrayListDestroy的类型，方便函数指针转换
*/


/** @typedef    typedef long (*tLynxArrayListLength) (LynxArrayList
                                                      myArrayList);
    @brief  定义了LynxArrayListLength的类型，方便函数指针转换
*/

/** @typedef    typedef BOOL (*tLynxArrayListIsEmpty) (LynxArrayList
                                                       myArrayList);
    @brief  定义了LynxArrayListIsEmpty的类型，方便函数指针转换
*/

/** @typedef    typedef long (*tLynxArrayListLocateElem) (LynxArrayList
                                                          myArrayList,
                                  void *elem,
    ...
    @brief  定义了LynxArrayListLocateElem的类型，方便函数指针转换
*/

/** @typedef    typedef BOOL (*tLynxArrayListInsert) (LynxArrayList
                                                      myArrayList,
                              long position,
                              void *elem
                             );
    @brief  定义了LynxArrayListInsert的类型，方便函数指针转换
*/

/** @typedef    typedef void *(*tLynxArrayListGetAndDelete) (LynxArrayList
                                                             myArrayList,
                                     long position
                                    );
    @brief  定义了LynxArrayListGetAndDelete的类型，方便函数指针转换
*/

/** @typedef    typedef long (*tLynxArrayListTraverse) (LynxArrayList
                                                        myArrayList,
                                void (*visit)(void *returns)
                               );
    @brief  定义了LynxArrayListTraverse的类型，方便函数指针转换
*/

/** @typedef    typedef void (*tLynxArrayListQsort) (LynxArrayList
                                                     myArrayList,
                             BOOL (*compare)(void *elema,
                                          void *elemb
                                                 )
                            );
    @brief  定义了LynxArrayListQsort的类型，方便函数指针转换
*/

/** @typedef    typedef void *(*tLynxArrayListBsearch)  (LynxArrayList
                                                         myArrayList,
                                 BOOL (*compare)(void *elema,
                                          void *elemb
                                                 )
                                );
    @brief  定义了LynxArrayListBsearch的类型，方便函数指针转换
*/
...
/** @fn long LynxArrayListLength (LynxArrayList myArrayList);
    @brief  获得整个线性表的长度
    @param  myArrayList LynxArrayList指针，该指针应当为有效的指针。
    @return 返回整个线性表的长度
*/
...
/** @fn void LynxArrayListQsort (LynxArrayList myArrayList,
                                 long (*compare)(void *elema,
                                          void *elemb
                                                 )
                                )
    @brief  对整个数组的所有元素进行快速排序
    @param  myArrayList LynxArrayList指针，该指针应当为有效的指针。
    @param  compare compare函数，由用户编写并传入
*/

/** @fn void *LynxArrayListBsearch  (LynxArrayList myArrayList,
                                     long (*compare)(void *elema,
                                            void *elemb
                                                 )
                                    )
    @brief  对整个数组的所有元素进行二分查找。之前必须排序
    @param  myArrayList LynxArrayList指针，该指针应当为有效的指针。
    @param  compare compare函数，由用户编写并传入
    @return 返回搜索的元素的指针。如果没有找到，返回NULL。
*/
...
#include <stdio.h>
    ...
    void LynxArrayListClear (LynxArrayList myArrayList,
                             BOOL (*freeElement) (void *elem)
                            );

    long LynxArrayListLength (LynxArrayList myArrayList);

    BOOL LynxArrayListIsEmpty (LynxArrayList myArrayList);

    void *LynxArrayListGetElem (LynxArrayList myArrayList,
                                long position
                               );

    long LynxArrayListLocateElem (LynxArrayList myArrayList,
                                  void *elem,
                                  long (*compare)(void *elema,
                                          void *elemb
                                                 )
    ...
    BOOL LynxArrayListInsert (LynxArrayList myArrayList,
                              long position,
                              void *elem
                             );

    void *LynxArrayListGetAndDelete (LynxArrayList myArrayList,
                                     long position
                                    );

    long LynxArrayListTraverse (LynxArrayList myArrayList,
                                void (*visit)(void *returns)
                               );

    void LynxArrayListQsort (LynxArrayList myArrayList,
                             long (*compare)(void *elema,
                                     void *elemb
                                            )
                            );

    void *LynxArrayListBsearch  (LynxArrayList myArrayList,
                                 long (*compare)(void *elema,
                                         void *elemb
                                                ),
                                 void *elem
